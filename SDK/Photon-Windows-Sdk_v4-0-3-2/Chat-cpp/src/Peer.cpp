...
namespace ExitGames
{
	namespace Chat
	{
		...
		bool Peer::opAuthenticateOnNameServer(const JString& appID, const JString& appVersion, const JString& region, const JString& userID, const AuthenticationValues& authenticationValues)
		{
		...
		bool Peer::opSendPrivateMessage(const JString& target, const Object& message, bool encrypt)
		{
			Photon::OperationRequestParameters op;
			op.put(ParameterCode::USER_ID, ValueObject<JString>(target));
			op.put(ParameterCode::MESSAGE, message);
