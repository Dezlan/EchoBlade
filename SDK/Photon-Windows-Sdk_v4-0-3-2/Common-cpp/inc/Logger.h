...
namespace ExitGames
{
	namespace Common
	{
		...
		public:
			...
			void log(DebugLevel::DebugLevel debugLevel, const EG_CHAR* file, const EG_CHAR* function, bool printBrackets, unsigned int line, const EG_CHAR* dbgMsg, ...) const;
			void vlog(DebugLevel::DebugLevel debugLevel, const EG_CHAR* file, const EG_CHAR* function, bool printBrackets, unsigned int line, const EG_CHAR* dbgMsg, va_list args) const;
